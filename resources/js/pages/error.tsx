...
/**
 * Branded 404 (SPEC §15.1): rendered by the exception handler in
 * bootstrap/app.php and always links back to the catalog.
 */
    ...
    return (
        <PublicLayout>
            ...
            <div className="mx-auto flex max-w-7xl flex-col items-center px-4 py-32 text-center sm:px-6 lg:px-8">
                ...
                <h1 className="mt-4 text-5xl font-semibold tracking-tight sm:text-6xl">This part isn't in the catalog</h1>
                <p className="mt-5 max-w-md leading-7 text-neutral-500">
                    The page you're looking for moved, never shipped, or was mistyped. The catalog is a good place to start again.
                </p>
